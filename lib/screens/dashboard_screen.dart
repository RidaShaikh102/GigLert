    ...
    return Consumer2<AuthProvider, AppStateProvider>(
      builder: (
        ...
        final String userName =
            authProvider.user?.displayName?.split(' ').first ?? 'Freelancer';
        final bool insideWindow = appState.settings.schedule.contains(now);
        final bool fullyConfigured = appState.permissionState.completedCount >= 4;
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        if (appState.lastNotification != null)
                          StatusPill(
                            label: appState.lastNotification!.type.toUpperCase(),
                            color: Theme.of(context).colorScheme.primary,
                          ),
                      ],
                    ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _ChecklistRow(
                      ...
                      ready: appState.permissionState.notificationListenerEnabled,
                    ),
                    _ChecklistRow(
                      title: 'Post notifications',
                      ready: appState.permissionState.postNotificationsGranted,
                    ),
                    _ChecklistRow(
                      title: 'Battery optimization excluded',
                      ready: appState.permissionState.batteryOptimizationIgnored,
                    ),
                    _ChecklistRow(
